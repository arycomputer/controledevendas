import type { Customer, Part, Sale } from './types';
...
export const parts: Part[] = [
  { id: 'p1', name: 'Parafuso Sextavado', description: 'M6x20mm Aço Inox', price: 0.50, quantity: 1000 },
  { id: 'p2', name: 'Porca M6', description: 'Porca sextavada M6', price: 0.25, quantity: 2000 },
  { id: 'p3', name: 'Arruela Lisa', description: 'Arruela M6', price: 0.10, quantity: 5000 },
  { id: 'p4', name: 'Filtro de Óleo', description: 'Para motor 1.6', price: 35.00, quantity: 50 },
  { id: 'p5', name: 'Vela de Ignição', description: 'Padrão universal', price: 15.00, quantity: 100 },
];
...
export const sales: Sale[] = [
    {
        ...
        customerId: '1',
        items: [
            { partId: 'p1', quantity: 50, unitPrice: 0.50 },
            { partId: 'p2', quantity: 50, unitPrice: 0.25 },
        ],
    ...
    },
    {
        ...
        customerId: '2',
        items: [
            { partId: 'p4', quantity: 1, unitPrice: 35.00 },
            { partId: 'p5', quantity: 4, unitPrice: 15.00 },
        ],
        totalAmount: 35.00 + (4 * 15.00),
    ...
    },
     {
        ...
        customerId: '3',
        items: [
            { partId: 'p3', quantity: 100, unitPrice: 0.10 },
        ],
    ...
    },
    {
        ...
        customerId: '1',
        items: [
            { partId: 'p5', quantity: 2, unitPrice: 15.00 },
        ],
        totalAmount: 2 * 15.00,
